...
data FieldDescriptor msg where
    FieldDescriptor :: Typeable value => String
...
data FieldAccessor msg value where
    ...
    --
    -- It also provides metadata for the key and value types to enable
    -- writing generalized instances.
    MapField :: (Typeable key, Typeable value, Ord key, Message entry) => MapKey key -> FieldTypeDescriptor value 
                     -> Lens' entry key -> Lens' entry value -> Lens' msg (Map key value) 
                     -> FieldAccessor msg entry
...
data MapKey t where
    MapInt32Key :: MapKey Int32
    MapInt64Key :: MapKey Int64
    MapUInt32Key :: MapKey Word32
    MapUInt64Key :: MapKey Word64
    MapSInt32Key :: MapKey Int32
    MapSInt64Key :: MapKey Int64
    MapFixed32Key :: MapKey Word32
    MapFixed64Key :: MapKey Word64
    MapSFixed32Key :: MapKey Int32
    MapSFixed64Key :: MapKey Int64
    MapBoolKey :: MapKey Bool
    MapStringKey :: MapKey T.Text
