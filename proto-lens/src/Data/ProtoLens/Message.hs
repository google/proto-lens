...
data FieldAccessor msg value where
    ...
    RepeatedField :: Lens' msg [value] -> FieldAccessor msg value
    PackedField :: V.Unbox value => Lens' msg (V.Vector value) -> FieldAccessor msg value
...
reverseRepeatedFields fields x0
  ...
  where
    ...
    reverseListField x (FieldDescriptor _ _ (RepeatedField f))
        = over f reverse x
